...
export const Deliveries = () => {
    ...
    return (
        <div className="py-[20px]">
            {contextHolder}
            <div className="container flex flex-row gap-[20px] max-lg:flex-col">
                <div className="p-[20px] flex flex-col gap-[20px] w-[calc(60%-20px)] border border-[#3A906B] shadow-[0_0_30px_0_#3A906B] rounded-[15px] max-lg:w-full">
                    ...
                    {isAuth && deliveries.length > 0 && (
                        <>
                            {deliveries.map((delivery: Delivery) => (
                                <div key={delivery._id} className="p-[20px] border border-[#3A906B] rounded-[15px] max-lg:order-2">
                ...
                <div className="max-lg:order-1 lg:order-2 p-[20px] w-[calc(40%-20px)] border border-[#3A906B] max-lg:w-full shadow-[0_0_30px_0_#3A906B] rounded-[15px]">
